...
const Last = () => {
  ...
  return (
    <section className="relative overflow-hidden" id="last">
      <div className="bg-[#d8d8d8] py-16 relative">
        <div className="absolute inset-0 bg-[#d8d8d8] rotate-[-3deg] scale-110 pointer-events-none"></div>
        <MaxWidthWrapper className="flex items-center flex-col relative z-10">
          <div className="relative pb-10 mt-2">
